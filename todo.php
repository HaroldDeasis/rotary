                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown active">
                        ...
                        <ul class="sub-menu children dropdown-menu active">
                            <li class="active"><i class="fa fa-dot-circle-o"></i><a href="todo.php">To Do</a></li>
                ...
                <div class="col-md-4">
                    <div class="card border border-success">
                        <div class="card-header">
                            <strong class="card-title">New Project</strong>
                        </div>
                        <div class="card-body">
                            <p class="card-text"><button class="btn btn-success btn-block"><i class="fa fa-plus">&nbsp;Create</i></button></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card border border-primary">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-success">Do the Project</button>
                    </div>
                </div>
            </div>
