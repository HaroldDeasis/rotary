    ...
    <div id="right-panel" class="right-panel">
       ...
       <?php require("header.php"); ?>
        ...
        <div class="container-fluid">
            ...
            <form method="get">
            <?php //SHOW OFFICERS FROM DATABASE
                        ...
                        <section class="card">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <button type="button" class="btn btn-danger btn-block" onclick="location.replace('officers.php?id=<?php echo $rotarian[3]; ?>&action=delete')">Delete</button>
            ...
            <?php //DELETE OFFICER FROM DATABASE
                $id = $_GET['id'];
                $action = $_GET['action'];
