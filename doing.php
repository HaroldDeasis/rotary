                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown active">
                        ...
                        <ul class="sub-menu children dropdown-menu active">
                            ...
                            <li class="active"><i class="fa fa-dot-circle-o"></i><a href="doing.php">Doing</a></li>
            ...
            <div class="col-lg-12">
                <div class="card border border-warning">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-danger">Stop Project</button>
                        <button class="btn btn-success">Project is Done</button>
                    </div>
                </div>
            </div>
