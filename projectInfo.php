...
<head>
    ...
    <title>Rotary | Project Info</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-dot-circle-o"></i><a href="donations.php">Donations</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-dot-circle-o"></i><a href="members.php">Members</a></li>
                            <li><i class="fa fa-dot-circle-o"></i><a href="officers.php">Officers</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <h3><center>Title of the Selected Project</center></h3>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            <div class="stat-icon dib"><i class="ti-angle-double-down text-danger border-danger"></i></div>
                    ...
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                ...
                                <div class="stat-digit">August 31, 2018</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            <div class="stat-icon dib"><i class="ti-angle-double-up text-success border-success"></i></div>
                            <div class="stat-content dib">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="control-label">Project Descripton</label>
                            <textarea class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Classification</label>
                            <input type="text" name="classification" class="form-control" value="Sample">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Venue</label>
                            <input type="text" name="venue" class="form-control" value="Sample">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Status</label>
                            <input type="text" name="status" class="form-control" value="Sample">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="beneficiaries" class="form-control" value="Sample">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Officers in Charge</label>
                            <input type="text" name="officersInCharge" class="form-control" value="Sample">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Classification</label>
                            <input type="text" name="classification" class="form-control" value="Sample">
                        ...
                        <div class="form-group">
                            <label class="control-label">Joint Project</label>
                            <input type="text" name="jojntProject" class="form-control" value="Sample">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Classification</label>
                            <input type="text" name="classification" class="form-control" value="Sample">
